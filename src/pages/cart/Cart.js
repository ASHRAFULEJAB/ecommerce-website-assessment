...
const Cart = () => {
  return (
    <div className="flex">
      ...
      <div className="lg:m-60">
        <div className='flex justify-center items-center'>
        <p className='text-6xl font-bold'>Cart Is C</p>
        <div className='w-9 h-9 border-8 border-dashed rounded-full animate-spin mt-3 border-purple-900'></div>
        <p className='text-6xl font-bold mr-2'>ming</p>
        <p className='text-6xl font-bold'>Soon</p>
      </div>
      </div>
    </div>
  );
